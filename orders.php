    ...
    <header id="header-wrap">
      ...
      <!-- Navbar End -->
        ...
        <section class="section-padding">
                ...
                <div class="row">
                  ...
                  <div class="col-4 col-md-2" style="padding-top: 10px;">
                    <select name="sort" class="custom-select category">
                        ...
                        <option value="amount">customer number</option>
                        <option value="type">Dish name</option>
                      </select>
                  </div>
                  <div class="col-1 col-md-1"></div>
                  <div class="col-2 col-md-2">
                    <p style="font-size: 15px; padding-top: 13px;">Display orders of :</p>
                  </div>
            ...
            <div class="container">
              <table style="width: 100%;" id="orders" class="styled-table">
                <thead>
                <tr>
                ...
                if($result = mysqli_query($link,$sql2)){
                    if(mysqli_num_rows($result) > 0){
                      while($row = mysqli_fetch_array($result)){
                        $dname = $row['t_id'];
                        $ddesc = $row['d_name'];
                        $dtype = $row['o_quantity'];
                        $dprice = $row['o_amount'];
                        $cnumber=$row['c_number'];
                        $datetime = $row['o_timestamp'];
                ?>
                <tr>
